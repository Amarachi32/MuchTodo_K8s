...
- `k8s_pods.png`: Shows all pods in a Running state.  
- `k8s_ingress_svc.png`: Shows the networking and service setup.  
- `browser_health_check.png`: Confirms the API is responding through the Ingress.  
